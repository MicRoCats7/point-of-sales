...
function UpdateData() {
  ...
  const navigate = useNavigate();
    ...
    const nambahData = (e) => {
        ...
        axios.put(API_URL + 'menu/update/' + param.id , data,
        {
          headers: {
  ...
  return (
    ...
    <div className='title-add'>
      <h1>Edit Data Makanan <br/> atau Minuman</h1>
    </div>
    <Form>
    <Form.Group className="mb-3">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Stok Makanan/Minuman" value={menuStock} onChange={(e) => setMenuStock(e.target.value)}/>
      </Form.Group>
